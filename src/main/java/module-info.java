...
module com.okancelik.bitirmeproject {
    ...
    exports com.okancelik.bitirmeproject.dao;

    // // Veritabanı bağlantı paketini dış dünyaya açıyoruz. Diğer modüller DB bağlantısını kullanabilir.
    exports com.okancelik.bitirmeproject.database;

    // Ana paketi dış dünyaya açıyoruz. Diğer modüller bu paketin içeriğini kullanabilir.
    exports com.okancelik.bitirmeproject;
    opens com.okancelik.bitirmeproject to javafx.base, lombok;
}
